...
@Component("LIC14952_PJT1005_PE_NLPd9a068bb-f5c5-4190-bd20-06e64f7724d9")
public class Enable_netword_tabs implements Nlp {
	@InputParams({ 
	...
	public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
		...
		try {
			...
			if(browser.equals("edge")) {
				EdgeOptions otions=new EdgeOptions();
				//options.adda
			}

...
//		dc.setCapability("appium:ignoreUnimportantViews", true);
        ...
        try {
            ...
            WebElement parentElement = driver.findElement(By.xpath("//android.widget.TextView[@text='@BARODAMPAY']/ancestor::android.widget.ListView"));
            while (true) {
                try {
                    ...
                    parentElement = driver.findElement(By.xpath("//android.widget.TextView[@text='@BARODAMPAY']/ancestor::android.widget.ListView"));

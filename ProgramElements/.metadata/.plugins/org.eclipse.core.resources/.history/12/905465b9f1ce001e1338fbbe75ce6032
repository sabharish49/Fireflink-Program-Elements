...
@Component("LIC14952_PJT1001_PE_NLP025378cf-13d7-4c93-bd2e-1e77f376df61")
public class FileUpload implements Nlp {
		          ...
		          WebDriver driver = nlpRequestModel.getWebDriver();
			        ...
			        try {
						...
						nlpResponseModel.setStatus(CommonConstants.fail);
			 		    nlpResponseModel.setMessage("failed to upload the file" +e);

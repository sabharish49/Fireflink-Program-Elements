...
@Component("LIC14952_PJT1001_PE_NLPb259edb6-9528-4df2-a1af-089f0c2f2a85")
public class FetchingColor implements Nlp {
	...
	public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
		...
		try {	
            ...
            while (it.hasNext()) {
                ...
                if (ans.contains(color1)) {
    				
    				color=color1;
    				break;
    			} else if (ans.contains(color2)) {
			...
			nlpResponseModel.setMessage("color fetched successfully"+color);
			...
			nlpResponseModel.setMessage("failed to fetch color" +e);
		}

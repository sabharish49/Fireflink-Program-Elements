...
@Component("LIC14952_PJT1001_PE_NLP617b1b9d-1985-4511-addc-bccef155f589")
public class GetNumbersFromInputString implements Nlp {
	
	    @InputParams({@InputParam(name = "qrPath", type = "java.lang.String")})
	    @ReturnType(name = "text", type = "java.lang.String")
	      ...
	      public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
	          ...
	          String qrPath = (String) attributes.get("qrPath");
	          ...
	          try {
	        	 ...
	        	 text= result.getText();
	          	...
	          	nlpResponseModel.setMessage("successfully fetched the text");
	            	...
	            	nlpResponseModel.setMessage("failed to fetch the text");

...
public class Get_data_from_Exel implements Nlp {
	...
	public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
		...
		try {
			 ...
			 finalString= readExcelData(file, Sheet, Rows, column);
		...
		nlpResponseModel.getAttributes().put("result", finalString);
		return nlpResponseModel;
	}
	
	
    public static String readExcelData(String filePath, String sheetName, int rowSize, int column) {
        String res = null;

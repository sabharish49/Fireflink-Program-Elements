...
@Component("LIC20128_PJT1001_PE_NLPf9ed42b7-7c61-4148-9714-73fee939089c")
public class sumOfListELement implements Nlp {
	      ...
	      public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
	         ...
	         Integer sum=0;
	          try {
	              ...
	              for (String str : List) {
	                  try {
	                	  intList.add(Integer.parseInt(str.replaceAll("[^0-9]","")));

...
@Component("LIC20369_PJT1002_PE_NLP51397d98-fa3b-4e2a-87e7-b01129a67fd9")
public class swipeElementFromLeftToRight implements Nlp {
	...
	public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
		...
		try {
			...
			int endX = x + (int) (sliderWidth * 0.9);
			...
			nlpResponseModel.setMessage("Successfully swiped the element from left to right");

		} catch (Exception e) {
			nlpResponseModel.setStatus(CommonConstants.fail);
			nlpResponseModel.setMessage("failed to swipe the element from left to right "+e);

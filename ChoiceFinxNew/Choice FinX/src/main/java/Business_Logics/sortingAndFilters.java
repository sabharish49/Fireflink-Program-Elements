...
@Component("LIC20369_PJT1002_PE_NLP8396dbc0-e69e-4c61-9966-5ddc650ab885")
public class sortingAndFilters implements Nlp {
    @InputParams({@InputParam(name = "sortInput", type = "java.lang.String"), @InputParam(name = "sortSection", type = "java.lang.String")})
    @ReturnType(name = "result", type = "java.lang.res")
      ...
      public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
          ...
          String sortSection = (String) attributes.get("sortSection");
          ...
          try {
        	...
        	ArrayList<String> checkBox = new ArrayList();
      		...
      		checkBox.add("Product Type");
      		checkBox.add("Validity Type");
      		checkBox.add("Order Status");
      		
      		
        	  
    		driver.findElement(By.xpath("//android.view.ViewGroup[@resource-id='com.choiceequitybroking.jiffy:id/vgSortBtn']")).click();
    		if(driver.findElement(By.xpath("//android.widget.TextView[@resource-id='com.choiceequitybroking.jiffy:id/tvResetAll']")).isDisplayed()) {
    			driver.findElement(By.xpath("//android.widget.TextView[@resource-id='com.choiceequitybroking.jiffy:id/tvResetAll']")).click();
    		}
    		
    		
    		ArrayList<String> checkBoxlist = new ArrayList();
    		
    		String section=sortSection;    		
    		...
    		while(mainWhile==false) {
    			...
    			for(int i=1;i<=parentElementsSize;i++) {
    				...
    				if(childElementsSize==Childlength_static || section.contains("Baskets")) {
    					
    					String xpath1 = "("+parentXpath+")["+i+"]";
    					String currentStockName = "";
    					String currentStockExchange_Invested="";
    					try {
    					...
    					if(!(stocks.contains(currentStockName+"-"+currentStockExchange_Invested))) {
    			...
    			try {
    				...
    				String LastStockExchange_Invested="";
    				try {
    		...
    		if(filters.contains("Sort")) {
    			...
    			boolean result= validateSortType(sortValues,sortType,sortElement);
    			
    			if(result==true) {
    				System.out.println("Succesfully filters are applied to Elements ");
    				nlpResponseModel.setStatus(CommonConstants.pass);
    				nlpResponseModel.setMessage("Successfully applied Filetrs and Validations for stocks");
    			}
    			else {
    				System.out.println("Failed to apply filters ");
    				nlpResponseModel.setStatus(CommonConstants.fail);
    				nlpResponseModel.setMessage("Failed to apply Filters and Validations for stocks ");
    			}
    		}
    		else {
    			if(notApplied!="") {
    				System.out.println(notApplied);
    				nlpResponseModel.setStatus(CommonConstants.fail);
    				nlpResponseModel.setMessage("Failed to apply Filters and Validations for stocks "+notApplied);
    			}
    			else {
        	  ...
        	  nlpResponseModel.setStatus(CommonConstants.fail);
			  nlpResponseModel.setMessage("Failed to apply Filters and Validations for stocks "+ e);
		}

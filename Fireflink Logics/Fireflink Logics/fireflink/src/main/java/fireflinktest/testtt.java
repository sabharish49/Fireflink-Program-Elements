...
public class testtt {
	...
	public static void main(String[] args) throws InterruptedException {
	   ...
	   // Thread.sleep(2000);
		...
		driver.findElement(By.xpath("//a[@id=\"menu-worksheets\"]")).click();
	   ...
	   wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.xpath("//p[text()='Xero Invoices']/..//div"))));
	   driver.findElement(By.xpath("//p[text()='Xero Invoices']/..//div")).click();	   
	   ...
	   driver.findElement(By.xpath("//input[@placeholder='Email address']")).sendKeys("abhisammy098@gmail.com");

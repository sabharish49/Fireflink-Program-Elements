...
@Component("LIC19774_PJT1002_PE_NLP9764b419-2b51-4b4e-b2a1-bb18ac38bba3")
public class Health_details implements Nlp {

	@InputParams({@InputParam(name = "Questions", type = "java.util.Map"),@InputParam(name = "Health Details", type = "java.util.Map"),@InputParam(name = "Insurer name", type = "java.util.List")})
	...
	public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
		...
		@SuppressWarnings("unchecked")
		Map<String, String> input = (Map<String,String>) attributes.get("Health Details");
		@SuppressWarnings("unchecked")
		List<String> names  = (List<String>) attributes.get("Insurer name");		 
		...
		catch (Exception e) 
		{
			...
			nlpResponseModel.setMessage("Failed to enter member details " +e);		
		}
		finally {

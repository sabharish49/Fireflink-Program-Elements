...
@Component("LIC19046_PJT1001_PE_NLP45be6889-7f1a-4186-889c-46b152c792d8")
...
//          String string2 = (String) attributes.get("string2");
		...
		try {
			...
			textfields.put("Current Experience In The Present Industry (years)", "5");
			...
			textfields.put("No Of Employees", "1");
			textfields.put("No. Of Customers/orders Observed During Business Visit", "10");
			textfields.put("noOfCustomersInDay", "2");
			textfields.put("Daily Sales/income", "100");
			textfields.put("Agricultural Land Owned (in Acres)", "2");
			textfields.put("millMachinery", "Small");
			textfields.put("Size Of The Shop (sq.ft)", "200");
			...
			dropdown.put("No Of Shops Owned", "0");

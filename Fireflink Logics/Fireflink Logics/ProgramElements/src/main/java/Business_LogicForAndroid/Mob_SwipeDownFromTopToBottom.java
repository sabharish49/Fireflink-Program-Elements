...
public class Mob_SwipeDownFromTopToBottom {
...
public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
	...
	try {
		...
		int startPoint = (int) (screenSize.getHeight() * 0.2);// Identify beginning point of scroll for X axis
		int endPoint = (int) (screenSize.getHeight() * 0.8);// Identify ending point of scroll
		int count = 0;

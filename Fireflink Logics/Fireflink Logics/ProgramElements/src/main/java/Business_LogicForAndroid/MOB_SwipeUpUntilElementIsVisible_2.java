...
@Component("LIC1710_PJT1014_PE_NLP3e8433f1-c100-4569-b596-93a65a646de2")
public class MOB_SwipeUpUntilElementIsVisible_2 implements Nlp {
	...
	public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
		...
		String maxSwipeCount = (String) attributes.get("Max swipe count");

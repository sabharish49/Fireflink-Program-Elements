...
@Component("LIC1710_PJT1014_PE_NLP028392d4-6266-4897-aadc-fd5bd29c35eb")
public class ContainsOrNot implements Nlp {
    ...
    @ReturnType(name = "getBoolean", type = "java.lang.Boolean")
      ...
      public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
          ...
          try
          {
        	...
        	if(stringText_1A.contains(stringText_2A))
        	{
        		getBoolean =true;
	          	nlpResponseModel.setStatus(CommonConstants.pass);
	          	nlpResponseModel.setMessage("Value 1 Contains Value 2");
        	}
        	else 
        	{
	          	nlpResponseModel.setStatus(CommonConstants.pass);
	          	nlpResponseModel.setMessage("Value 1 Not Contains Value 2");
        	}
          } 
          catch (Exception e) 
          {

...
@Component("LIC1710_PJT1014_PE_NLP620d2080-4bcc-45f5-a485-92ac64a38038")
public class ConvertStringValueToInteger implements Nlp {
     ...
     @ReturnType(name = "Return Integer Value", type = "java.lang.Integer")
      ...
      public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
          ...
          try
          {
        		...
        		double dub = Double.valueOf(stringValue.replaceAll("[^0-9]", ""));
        		integerValue = (int) Math.round(dub/100);

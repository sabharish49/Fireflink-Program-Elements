...
public class PerformKeyoperations implements Nlp {
	...
	public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
		...
		try {
			if (driver!=null) {
				...
				new Actions(iosDriver).sendKeys(KeyPad.toUpperCase()).perform();
			...
			nlpResponseModel.setStatus(CommonConstants.fail);
			nlpResponseModel.setMessage("Failed to perform Action keys" + e);
		}

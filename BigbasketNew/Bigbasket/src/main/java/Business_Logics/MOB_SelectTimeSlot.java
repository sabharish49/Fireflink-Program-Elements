...
@Component("LIC20665_PJT1001_PE_NLP7296b162-4989-4d64-a81b-a6ff041d869f")
public class MOB_SelectTimeSlot implements Nlp {
	...
	public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
		...
		try {
			...
			if (androidDriver!=null) {
				...
				String headerElementXpath = "//XCUIElementTypeStaticText[@name='"+formattedDate+"']";
					
				String timeSlotXpath = "(//XCUIElementTypeStaticText[@name='"+formattedDate+"']/following::XCUIElementTypeStaticText[@name='"+slotTime+"'])[1]";
				...
				while (isDisplayed == false) {
					try {
						startTime = System.currentTimeMillis();
						if (iosDriver.findElement(By.xpath(headerElementXpath)).isDisplayed()) {
							boolean time = false;
							while (time == false) {
								try {
									startTime = System.currentTimeMillis();
									WebElement timeSlotElement = iosDriver.findElement(By.xpath(timeSlotXpath));
